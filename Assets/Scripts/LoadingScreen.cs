...
public class LoadingScreen : MonoBehaviour
{
    ...
    private const float MIN_TIME_TO_SHOW = 4f;
    ...
    private void SetProgress(float progress)
    {
        ...
        if (timeElapsed > 3.0f)
        {
            waitingText.text = "Pancakes ready to flip !";
        }
        else if (timeElapsed > 2.0f)
        {
            waitingText.text = "Stacking and sorting pancakes ...";
        }
        else if (timeElapsed > 1.0f)
        {
            waitingText.text = "Cooking pancakes ...";
        }
        else
        {
            waitingText.text = "Pancakes in preparations";
        }
    }
